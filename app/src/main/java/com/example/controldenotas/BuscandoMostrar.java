...
public class BuscandoMostrar extends AppCompatActivity {
    ...
    String nameactivity, namemateria;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buscandomostrar);
        ...
        this.btnMostrarAlumnosCalificar = (Button) findViewById(R.id.btnMostrarNOTAS);
        ...
        Intent intentMostrando = new Intent(this, MostrarNotasAlumno.class);
        this.cargarDatos();
        ...
        acMateria.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                namemateria = (String)parent.getItemAtPosition(position);
        ...
        btnMostrarAlumnosCalificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(validar >= 4) {
                    ...
                    bundle.putString("Materia", namemateria);
                    ...
                    try {
                        if (notadao.geti(idValidadorUnico) != 0) {
                            ...
                            Toast.makeText(getApplicationContext(), "Actividad NO HA SIDO calificada", Toast.LENGTH_SHORT).show();
                        }
                    }catch (Exception e){}
                }else{
